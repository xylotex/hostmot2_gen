...
unsigned char data;
data= *(extbus + (address<<1));
return data;
}
//--------------------------------------------------------------------------------------
// 
//--------------------------------------------------------------------------------------
uint16_t bus_readword(uint16_t address) {
uint16_t data;

data=*(uint16_t  *)(extbus + (address));
return data;
}
//--------------------------------------------------------------------------------------
// 
...
// all calls shouldbe 16 bits wide
static inline int hm2_Xi90_gpmc_read(hm2_Xi90_t *board, u16 addr)
 {
int val;

val=bus_readbyte(addr);
